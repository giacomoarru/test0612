...
import com.gmail.giacomo.app.HasLogger;
import com.gmail.giacomo.app.security.CurrentUser;
import com.gmail.giacomo.backend.data.entity.AbstractEntity;
import com.gmail.giacomo.backend.data.entity.util.EntityUtil;
import com.gmail.giacomo.backend.service.CrudService;
import com.gmail.giacomo.backend.service.UserFriendlyDataException;
import com.gmail.giacomo.ui.utils.messages.CrudErrorMessage;
import com.gmail.giacomo.ui.utils.messages.Message;
import com.gmail.giacomo.ui.views.EntityView;
...
public class EntityPresenter<T extends AbstractEntity, V extends EntityView<T>>
	...
	public boolean loadEntity(Long id, CrudOperationListener<T> onSuccess) {
		return executeOperation(() -> {
			state.updateEntity(crudService.load(currentUser.getUser(), id), false);
			onSuccess.execute(state.getEntity());
		});
	}
